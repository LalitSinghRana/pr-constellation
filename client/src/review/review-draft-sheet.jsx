import { AlertTriangle, MessageSquarePlus, Send, Trash2 } from "lucide-react";
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          ...
          title={headStale ? "New commits on this pull request" : undefined}
          type="button"
          variant="outline"
        >
      ...
      <SheetContent className="w-full gap-0 overflow-hidden p-0 sm:max-w-md">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
          {headStale ? (
            <p className="flex items-start gap-2 rounded-md border border-warning/25 bg-warning/10 px-3 py-2 text-sm text-warning-strong">
              <AlertTriangle aria-hidden="true" className="mt-0.5 shrink-0" size={16} />
              <span>
                The branch has moved ahead since this review was generated. Comments and reviews
                you submit here target this review's commit.
              </span>
            </p>
          ) : null}
          {!canWrite ? (
