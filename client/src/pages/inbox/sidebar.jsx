...
export function Brand() {
  return (
    <a
      ...
      href="/"
      aria-label="PR Constellation home"
    >
      <span
      ...
      <span>
        <strong className="block text-[0.95rem] tracking-[-0.01em]">PR Constellation</strong>
  ...
  return (
    <SidebarRoot className="border-sidebar-border">
      ...
      <SidebarContent className="px-3 py-2">
        <nav aria-label="PR Constellation navigation">{children}</nav>
      </SidebarContent>
