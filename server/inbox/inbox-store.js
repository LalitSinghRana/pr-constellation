...
export class InboxStore {
  ...
  #migrateReviewDraftComments() {
    ...
    if (this.#metadata("review-draft-comment-line-deduped") === "1") {
      return;
    }
    this.#database.exec(migrateDraftCommentLines);
    this.#database.prepare(upsertAppMetadata).run("review-draft-comment-line-deduped", "1");
  }
