...
The judge focuses on file-local review quality: classification, explanations, risk,
logical root selection, and whether tree branches express review causality
