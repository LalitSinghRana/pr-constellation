...
export async function startServer() {
  ...
  const appVite = await createViteServer({
    appType: "spa",
    configFile: join(projectRoot, "notifications", "vite.config.js"),
    plugins: [dashboardPlugin],
    root: join(projectRoot, "notifications"),
  ...
  return server.listen(port, host, () => {
    console.log(`PR Review Cockpit: ${cockpitOrigin}/reviews`);
    console.log(`AI analyzer queue: ${cockpitOrigin}/analyze`);
  });
}
